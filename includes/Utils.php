...
class Utils {
    ...
    public static function format_duration( $seconds ) {
        ...
        $duration = array(
            _n( 'hour', 'hours', $hours, 'coffee_plugins_bol_connector' )       => $hours,
            _n( 'minute', 'minutes', $minutes, 'coffee_plugins_bol_connector' ) => $minutes,
            _n( 'second', 'seconds', $seconds, 'coffee_plugins_bol_connector' ) => $seconds
        );
